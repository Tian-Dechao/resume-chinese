...
\MyNamelink{Dechao Tian}{PHONE (1) 412-583-6800}{dechaotian@gmail.com}{https://tian-dechao.github.io}
...
\WorkEntry{Centers for Disease Control and Prevention , USA}{ORISE Fellow}{April 2019 - Present} 
{\begin{itemize}
\item Develop advanced machine learning algorithms to identify anomaly clusters from high-dimensional character Whole-genome sequencing data and linked epidemiological data. 
\item Teach R software.
\end{itemize}}
\WorkEntry{Carnegie Mellon University, USA}{Postdoctoral Research Associate}{April 2015 - March 2019} 
{\begin{itemize}
...
\begin{etaremune}
\item \ManEntry{\textbf{Tian D}$^\star$, Zhang R$^\star$, Zhang Y, and Ma J}{MOCHI enables discovery of heterogeneous interactome modules in 3D nucleome}{bioRxiv, doi: https://doi.org/10.1101/542092. First round revision for Genome Research}
